...
class OpenProviderRequest
{
    ...
    public function _getRequest ()
    {
        ...
        if (isset($this->misc)) {
            ...
            OpenProviderApi::convertPhpObjToDom($this->misc, $miscElement, $dom);
        }
        ...
        OpenProviderApi::convertPhpObjToDom($this->args, $cmdNode, $dom);
